...
<div class="card">
  ...
  <div class="card-body">
    <h5 class="card-title">Analyse des Rapports <span>| Explications</span></h5>

    <div class="activity">
      <div class="explanation-item d-flex align-items-center mb-4">
        <i class='bi bi-bar-chart-fill text-success icon-style'></i>
        <div class="explanation-content ms-3">
          <strong>Performance Globale : </strong> Les tendances générales dans le graphique montrent la croissance de vos revenus ou la diminution des coûts au fil du temps. Un pic important peut indiquer un changement stratégique réussi, tandis qu'une baisse soudaine peut signaler un problème nécessitant une attention rapide.
        </div>
      </div><!-- End explanation item-->

      <div class="explanation-item d-flex align-items-center mb-4">
        <i class='bi bi-arrow-up-right-circle-fill text-primary icon-style'></i>
        <div class="explanation-content ms-3">
          <strong>Opportunités de Croissance : </strong> Les périodes où la ligne de croissance monte fortement peuvent être liées à des événements spécifiques (promotion, saisonnalité, nouvelles campagnes marketing). Il est important de maximiser ces moments pour investir davantage et soutenir la croissance.
        </div>
      </div><!-- End explanation item-->

      <div class="explanation-item d-flex align-items-center mb-4">
        <i class='bi bi-pie-chart-fill text-warning icon-style'></i>
        <div class="explanation-content ms-3">
          <strong>Analyse par Segment : </strong> Si le graphique est segmenté (par produit, service ou région), cela permet d'identifier quels segments sont les plus performants ou les moins performants. Par exemple, si une région montre une baisse, il pourrait être utile de réévaluer les stratégies locales.
        </div>
      </div><!-- End explanation item-->

      <div class="explanation-item d-flex align-items-center mb-4">
        <i class='bi bi-lightbulb-fill text-info icon-style'></i>
        <div class="explanation-content ms-3">
          <strong>Recommandations : </strong> Sur la base de ces tendances, vous pouvez décider d'augmenter les investissements dans des campagnes performantes, de diversifier les produits ou services offerts, ou d'optimiser les coûts dans les segments moins performants.
        </div>
      </div><!-- End explanation item-->

      <div class="explanation-item d-flex align-items-center">
        <i class='bi bi-exclamation-triangle-fill text-danger icon-style'></i>
        <div class="explanation-content ms-3">
          <strong>Risques Potentiels : </strong> Une baisse continue ou un comportement inhabituel dans les données pourrait signaler des risques (concurrence accrue, perte de clientèle). Prendre des mesures correctives rapidement est essentiel pour minimiser les impacts.
        </div>
      </div><!-- End explanation item-->
    </div>
  </div>
...
<div class="card">
  ...
  <div class="card-body">
    <h5 class="card-title">Tendances des Favoris <span>| Explication</span></h5>

    <div class="activity">
      <div class="activity-item d-flex">
        <i class="bi bi-info-circle activity-badge text-info align-self-start"></i>
        <div class="activity-content">
          Le graphique ci-dessus vous montre les tendances des utilisateurs qui ont ajouté vos logements à leurs favoris au cours des dernières semaines. Cela peut vous aider à comprendre quels types de logements sont les plus populaires auprès des utilisateurs.
        </div>
      </div><!-- End explanation item-->
      ...
      <div class="activity-item d-flex">
        ...
        <div class="activity-content">
          En observant les pics sur le graphique, vous pouvez identifier les périodes où votre activité a suscité le plus d'intérêt. Par exemple, une augmentation soudaine des favoris pourrait être liée à une mise en avant de vos annonces ou à une forte demande saisonnière.
        </div>
      </div><!-- End explanation item-->
      ...
      <div class="activity-item d-flex">
        ...
        <div class="activity-content">
          Si vous constatez une baisse des favoris, cela peut indiquer une baisse d'intérêt pour vos logements. Il serait alors intéressant de revoir la description, les photos, ou même de proposer des offres spéciales pour attirer de nouveaux utilisateurs.
        </div>
      </div><!-- End explanation item-->
      ...
      <div class="activity-item d-flex">
        ...
        <div class="activity-content">
          Comparez les données mensuelles pour voir si certains types de logements sont plus ajoutés en favoris à certaines périodes de l'année, par exemple en haute saison touristique ou lors d'événements locaux.
        </div>
      </div><!-- End explanation item-->
      ...
      <div class="activity-item d-flex">
        ...
        <div class="activity-content">
          Utilisez ces informations pour adapter votre stratégie de location et optimiser vos chances d'attirer plus d'utilisateurs en fonction des tendances observées.
        </div>
      </div><!-- End explanation item-->
    </div>
...
/* Adding space between the explanation items */
.explanation-item {
    margin-bottom: 20px; /* Ajoute de l'espace entre les éléments */
}

.explanation-content {
    font-size: 16px; /* Taille de la police pour les explications */
}
