     ...
     <div class="col-lg-8">
       <div class="row">
         ...
         <div class="card">
            ...
            <div class="news">
            <div class="post-item clearfix" v-for="commentaire in commentaires" :key="commentaire.id">
                <img :src="commentaire.logement.images.url || '@/assets/img/default.jpg'" alt="">
                <p><strong>Utilisateur : </strong>{{ commentaire.nom_complet }}</p> <!-- Affichage du nom complet de l'utilisateur -->
                <h4><a :href="'/commentaires/' + commentaire.id"> Nom du logement : {{ commentaire.logement.titre }}</a></h4>
                <p>{{ commentaire.description }}</p>
                <h4><a :href="'/commentaires/' + commentaire.id"> Note : {{ commentaire.note }}/5</a></h4>
                ...
                <div class="card-body">
                    ...
                    <div class="activity">
                        ...
                        <div class="explanation-content ms-3">
                            <strong>Performance Globale : </strong> Les tendances dans le graphique des commentaires montrent l'évolution de la satisfaction des utilisateurs au fil du temps. Un pic important peut indiquer une réponse positive à un événement ou à une amélioration, tandis qu'une baisse soudaine peut signaler des problèmes nécessitant une attention rapide.
                        </div>
                        ...
                        <div class="explanation-content ms-3">
                            <strong>Opportunités d'Amélioration : </strong> Les périodes où le nombre de commentaires positifs augmente peuvent être liées à des changements spécifiques (nouveaux services, amélioration de l'expérience utilisateur). Il est essentiel de capitaliser sur ces moments pour renforcer l'engagement des utilisateurs et fidéliser la clientèle.
                        </div>
                        </div><!-- End explanation item-->
                        ...
                        <div class="explanation-content ms-3">
                            <strong>Analyse par Catégorie : </strong> Si les commentaires sont segmentés (par type de logement, région, etc.), cela permet d'identifier quels segments reçoivent le plus de retours positifs ou négatifs. Par exemple, si un type de logement montre une forte critique, il pourrait être utile de réévaluer les services ou les installations offertes.
                        </div>
                        </div><!-- End explanation item-->
                        ...
                        <div class="explanation-content ms-3">
                            <strong>Recommandations : </strong> Sur la base de ces analyses, vous pouvez décider d'améliorer les aspects qui reçoivent des critiques négatives, d'encourager les commentaires sur les services performants, ou d'ajuster votre offre en fonction des retours des utilisateurs.
                        </div>
                        </div><!-- End explanation item-->
                        ...
                        <div class="explanation-content ms-3">
                            <strong>Risques Potentiels : </strong> Une augmentation continue des commentaires négatifs pourrait signaler des problèmes sérieux (insatisfaction des clients, problèmes de qualité). Il est crucial de répondre rapidement à ces préoccupations pour minimiser l'impact sur votre réputation et vos affaires.
                        </div>
                        </div><!-- End explanation item-->
                    </div>
                </div>
