<template>
  ...
  <div class="reservation-container">
    <h2>Liste des Réservations Acceptées</h2>

    <!-- Tableau des réservations -->
    <table v-if="filteredReservations.length">
      <thead>
        <tr>
          <th>Logement</th>
          <th>Adresse</th>
    ...
    <p v-else>Aucune réservation acceptée trouvée.</p>
...
export default {
  ...
  computed: {
    ...
    filteredReservations() {
      return this.reservations.filter(reservation => reservation.statut === 'ACCEPTEE');
    }
  },
  created() {
