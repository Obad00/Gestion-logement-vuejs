<!-- <template>
    ...
    <main style="background: #F3FFF4; padding-top: 100px;">
        ...
        <div class="property-grid">
            ...
            <div class="property-card">
                ...
                <div class="property-info">
                    <div class="property-price">
                        <span class="price">200.000 F</span>
                        <a href="#" class="voir-button">Voir</a>
                    </div>
                    
                    <p class="location">Mbour</p>
                    <p class="status rent">A louer</p>
                    <!-- <a href="#" class="view-link">Voir</a> -->
                    <div class="property-details">
                        <span><img src="@/assets/img/bedroom-icon.svg" alt="">3 Chambres</span>
                        <span><img src="@/assets/img/bathroom-icon.svg" alt="">4 Toilettes</span>
                        <span><img src="@/assets/img/area-icon.svg" alt="">360m²</span>
                    </div>
                </div>
            </div>
            <!-- Card 2 -->
            <div class="property-card">
                <img src="@/assets/img/house2.png" alt="Maison à Diamniadio">
                <div class="property-info">
                    <div class="property-price">
                        <span class="price">200.000 F</span>
                        <a href="#" class="voir-button">Voir</a>
                    </div>
                    <p class="location">Diamniadio</p>
                    <p class="status sale">En vente</p>
                    <!-- <a href="#" class="view-link">Voir</a> -->
                    <div class="property-details">
                        <span><img src="@/assets/img/bedroom-icon.svg" alt="">3 Chambres</span>
                        <span><img src="@/assets/img/bathroom-icon.svg" alt="">4 Toilettes</span>
            ...
            <!-- Card 3 -->
            <div class="property-card">
                <img src="@/assets/img/house3.png" alt="Maison à Ouakam">
                <div class="property-info">
                    <div class="property-price">
                        <span class="price">200.000 F</span>
                        <a href="#" class="voir-button">Voir</a>
                    </div>
                    <p class="location">Ouakam</p>
                    <p class="status rent">A louer</p>
                    <div class="property-details">
                        <span><img src="@/assets/img/bedroom-icon.svg" alt="">3 Chambres</span>
                        <span><img src="@/assets/img/bathroom-icon.svg" alt="">4 Toilettes</span>
            ...
            <!-- Card 4 -->
            <div class="property-card">
                <img src="@/assets/img/house4.png" alt="Maison à Mamelle">
                <div class="property-info">
                    <div class="property-price">
                        <span class="price">200.000 F</span>
                        <a href="#" class="voir-button">Voir</a>
                    </div>
                    <p class="location">Mamelle, Ouakam</p>
                    <p class="status rent">A louer</p>
                    <div class="property-details">
                        <span><img src="@/assets/img/bedroom-icon.svg" alt="">3 Chambres</span>
                        <span><img src="@/assets/img/bathroom-icon.svg" alt="">4 Toilettes</span>
            ...
            <!-- Card 5 -->
            <div class="property-card">
                <img src="@/assets/img/house5.png" alt="Maison à Sacré Cœur">
                <div class="property-info">
                    <div class="property-price">
                        <span class="price">200.000 F</span>
                        <a href="#" class="voir-button">Voir</a>
                    </div>
                    <p class="location">Sacré Cœur</p>
                    <p class="status rent">A louer</p>
            ...
            <!-- Card 6 -->
            <div class="property-card">
                <img src="@/assets/img/house6.png" alt="Maison à Dakar Ville">
                <div class="property-info">
                    <div class="property-price">
                        <span class="price">200.000 F</span>
                        <a href="#" class="voir-button">Voir</a>
                    </div>
                    <p class="location">Dakar Ville</p>
                    <p class="status rent">A louer</p>
                    <div class="property-details">
                        <span><img src="@/assets/img/bedroom-icon.svg" alt="">3 Chambres</span>
                        <span><img src="@/assets/img/bathroom-icon.svg" alt="">4 Toilettes</span>
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (carouselItems.length > 0 && carouselImages && prevButton && nextButton) {
    ...
    console.error('Le carrousel ou ses éléments ne sont pas correctement définis.');
  }
});
...
.srvc:hover {
    background: linear-gradient(135deg, #356F37, #000000); /* Fond vert au survol */
    color: #ffffff;
}
...
.search-button:hover,
.search-button.active { /* Apply styles for hover and active (selected) */
...
.carousel-info h3, .carousel-info p, .btn-visualiser {
  margin: 10px 0;
}
